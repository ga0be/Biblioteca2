...
public class Main {
    public static void main(String[] args) {
       ...
       // Livro livroDefault = new Livro();
        ...
        try{
        repositorio.cadastrarAdministrador("Nelson", "Adm", "Nelson2002", "Cavacomeu", "182927", 1650.0);
        repositorio.cadastrarAdministrador("Angela", "Adm", "Angela145", "Tristezasnaopagamdividas", "1234", 1650.0);
        repositorio.cadastrarAtendente("Bartolomeu", "Atendente", "Bartoz89", "lajescriptograficas", "31415", "Manhã", 40.5, 5.0);
        repositorio.cadastrarAtendente("Carola", "Atendente", "Carororo123", "decamisola", "9265", "tarde", 40.5, 5.0);}
        catch (Exception e){
            print(e.getMessage());
        }
